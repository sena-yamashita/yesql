if Code.ensure_loaded?(Tds) do
  defmodule Yesql.Stream.MSSQLStream do
    ...
    def with_stats(conn, sql, params, processor, opts \\ []) do
      ...
      {result, final_row_count, final_chunk_count} =
        process_with_chunks_with_stats(conn, sql, params, processor, opts)
    ...
    defp process_with_chunks_with_stats(conn, sql, params, processor, opts) do
      ...
      process_chunk_recursive_with_stats(
        conn,
        sql,
        params,
        processor,
    ...
    defp process_chunk_recursive_with_stats(
           conn,
           sql,
           params,
           processor,
